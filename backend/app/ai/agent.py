...
SYSTEM_PROMPT = (
    ...
    "this project.\n"
    "Answer format: lead with a single-line direct answer, then add tight markdown "
    "bullets only if they carry extra detail. Always give numbers with their units. "
